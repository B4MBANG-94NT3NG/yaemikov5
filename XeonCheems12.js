...
//want more free bot scripts? subscribe to my youtube channel: https://instagram.com/someone.ex._
...
title: botname,
body: ownername,
thumbnailUrl: 'https://ibb.co/85nmq0S',
sourceUrl: websitex
},
},
text: txt,
...
let me = m.sender
let teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://i.ibb.co/yXmZ2b/donate.png`
...
case 'sound160':
case 'sound161':
XeonBotInc_dev = await getBuffer(`https://github.com/B4mbang-94nt3ng/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
...
if (!args[0]) return replygcxeon(`Where is the link?\nExample :\n${prefix}${command} https://github.com/B4mbang-94nt3ng/XeonMedia`)
...
break
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh = `ꜱᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ ᴅᴀꜱʜʙᴏᴀʀᴅ ʙᴏᴛ ᴋᴀᴍɪ*!
...
*.ꜱɪᴍᴘʟᴇᴍᴇɴᴜ*
*.ᴀʟʟᴍᴇɴᴜ*`
XeonBotInc.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/85097915e582651bbe202.jpg`}, caption: xmenu_oh}, {quoted: m})
}
break
case 'simplemenu': {
       await loading()
...
│々${prefix}groupmenu
│々${prefix}ownermenu
│々${prefix}convertmenu
│々${prefix}listmenu
│々${prefix}religionmenu
│々${prefix}photooxymenu
│々${prefix}animemenu
│々${prefix}nsfwmenu
│々${prefix}randomphotomenu
│々${prefix}randomvideomenu
│々${prefix}stickermenu
│々${prefix}databasemenu
│々${prefix}storemenu
│々${prefix}stalkermenu
│々${prefix}bugmenu
│々${prefix}othermenu
└─────────────────┈ ⳹`
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"My Instagram\",\"url\":\"https://instagram.com/someone.ex._\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"Telegram 💧\",\"url\":\"https://t.me/sadboy789\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"GitHub 🔘\",\"url\":\"https://github.com/B4mbang-94nt3ng\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"WhatsApp ☘️\",\"url\":\"https://wa.me/62895412691100\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"Allmenu 🗂️","id":"${prefix}allmenu"}`
